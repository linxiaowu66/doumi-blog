...
var ConfigProviderImpl = /** @class */ (function () {
  ...
  ***REMOVED***
    ConfigProviderImpl.prototype.get = function (key, defaultValue) {
        return jexl.evalSync(key, {"malagu":{"logger":{"level":"info","winstonConfig":{"level":"info"***REMOVED***,"dailyRotateConfig":{"frequency":"24h","filename":"doumi-blog-%DATE%.log","dirname":"./log"***REMOVED******REMOVED***,"session":{"autoCommit":true,"maxAge":86400000,"sessionIdKey":"malagu:sessionId","sessionKey":"malagu:session"***REMOVED***,"server":{"path":"/","port":3000,"endpoint":"http://localhost:{port***REMOVED***"***REMOVED***,"trace":{"responseField":"X-Malagu-Trace-ID"***REMOVED***,"mvc":{"path":"/*","defaultViewName":"json"***REMOVED***,"mustache":{"cache":false,"baseViewDir":"assets/views"***REMOVED***,"rpc":{"path":"api"***REMOVED***,"security":{"enabled":true,"usernameKey":"email","passwordKey":"password","contextKey":"malagu:securityContext","username":"admin","password":"MzQ0NTg4ZTk2NzQyYWI1ODA1MDFlNDBjMzZhZDY4OWQ1Zjc5ZDYxYzc2MjQ1NWZk","passwordEncoder":{"secret":"doumiblog","encodeHashAsBase64":true***REMOVED***,"basic":{"realm":"realm"***REMOVED***,"loginPage":"/#/blog/auth/login","loginUrl":"/api/login","loginMethod":"POST","loginSuccessUrl":"/#/blog/admin/index","logoutUrl":"/api/logout","logoutMethod":"POST","logoutSuccessUrl":"/#/blog/auth/login"***REMOVED***,"web":{"cors":{"origin":"https://blog.5udou.cn"***REMOVED******REMOVED***,"webpack":{"forkTSCheckerWebpackPlugin":{"eslintOptions":{"fix":true***REMOVED******REMOVED******REMOVED***,"core":{"validationPipeOptions":{"detailedOutputDisabled":false,"transformEnabled":true***REMOVED******REMOVED***,"cookies":{"keys":["abcdef"]***REMOVED***,"typeorm":{"ormConfig":[{"type":"mysql","host":"127.0.0.1","port":3306,"synchronize":false,"useUnifiedTopology":true,"charset":"utf8mb4_unicode_ci","username":"dev","password":"123456","database":"douMiBlog"***REMOVED***]***REMOVED******REMOVED***,"webpackHooks":["src/hooks/webpack"],"initHooks":[],"buildHooks":[],"deployHooks":["src/hooks/deploy"],"serveHooks":[],"mode":["local","cdn"],"entry":"@malagu/web/lib/node/application/dev-application-entry","modules":["src/node/module"],"assets":[]***REMOVED***) || defaultValue;
    ***REMOVED***
...
then(function () { return Promise.resolve(__webpack_require__(/*! malagu-winston/lib/node/module */ "./node_modules/malagu-winston/lib/node/module.js")).then(load) ***REMOVED***).
...
var LoggerImpl = /** @class */ (function () {
  ...
  ***REMOVED***
    LoggerImpl.prototype.error = function (message, context) {
        if (context === void 0) { context = ''; ***REMOVED***
    ...
    HtmlView.prototype.render = function (model, viewName) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                template = fs_extra_1.readFileSync(path_1.join(__dirname, baseViewDir, viewName), { encoding: 'utf8' ***REMOVED***
                if (cache) {
                        ...
                        return [4 /*yield*/, channelStrategy.handleChannels(function () { return __awaiter(_this, void 0, void 0, function () {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 3: throw new node_1.NotFoundError("Cannot find a service for the path: " + path);
                                  ***REMOVED***
                                ***REMOVED***
                            ***REMOVED*** ***REMOVED***)];
                    case 1:
...
var ElPolicyResolver = /** @class */ (function () {
  ...
  ***REMOVED***
    ElPolicyResolver.prototype.resolve = function (policy, securityMetadata) {
        return jexl_1.eval(policy.el, policy.context || node_1.Context.getAttr(access_protocol_1.SECURITY_EXPRESSION_CONTEXT_KEY));
    ***REMOVED***
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        resource = context.target.constructor.name;
                        return [2 /*return*/, {
...
/***/ "./node_modules/@malagu/security/lib/node/authentication/authentication-handler-adapter.js":
/*!*************************************************************************************************!*\
  !*** ./node_modules/@malagu/security/lib/node/authentication/authentication-handler-adapter.js ***!
  \*************************************************************************************************/
/*! no static exports found */
...
var AuthenticationHandlerAdapter = /** @class */ (function () {
    function AuthenticationHandlerAdapter() {
        this.priority = authentication_protocol_1.AUTHENTICATION_HANDLER_ADAPTER_PRIORITY;
  ***REMOVED***
    AuthenticationHandlerAdapter.prototype.handle = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.authenticationManager.authenticate()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
              ***REMOVED***
        ...
        ***REMOVED***
    ***REMOVED***
    AuthenticationHandlerAdapter.prototype.canHandle = function () {
        return this.authenticationManager.support();
    ***REMOVED***
    __decorate([
        core_1.Autowired(authentication_protocol_1.AuthenticationManager),
        __metadata("design:type", Object)
    ], AuthenticationHandlerAdapter.prototype, "authenticationManager", void 0);
    AuthenticationHandlerAdapter = __decorate([
        core_1.Component(node_1.HandlerAdapter)
    ], AuthenticationHandlerAdapter);
    return AuthenticationHandlerAdapter;
***REMOVED***());
exports.AuthenticationHandlerAdapter = AuthenticationHandlerAdapter;
...
exports.AUTHENTICATION_HANDLER_ADAPTER_PRIORITY = 500;
exports.DEFAULT_AUTHENTICATION_PROVIDER_PRIORITY = 2000;
...
var AuthenticationProviderImpl = /** @class */ (function () {
    function AuthenticationProviderImpl() {
        this.priority = authentication_protocol_1.DEFAULT_AUTHENTICATION_PROVIDER_PRIORITY;
  ***REMOVED***
...
__export(__webpack_require__(/*! ./authentication-handler-adapter */ "./node_modules/@malagu/security/lib/node/authentication/authentication-handler-adapter.js"));
    ...
    SessionSecurityContextStore.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                if (!context) {
                    return [2 /*return*/, this.securityContextStrategy.create()];
              ***REMOVED***
...
__export(__webpack_require__(/*! ./logout-handler-adapter */ "./node_modules/@malagu/security/lib/node/logout/logout-handler-adapter.js"));
...
/***/ "./node_modules/@malagu/security/lib/node/logout/logout-handler-adapter.js":
/*!*********************************************************************************!*\
  !*** ./node_modules/@malagu/security/lib/node/logout/logout-handler-adapter.js ***!
  \*********************************************************************************/
/*! no static exports found */
...
var LogoutHanlderAdapter = /** @class */ (function () {
    function LogoutHanlderAdapter() {
        this.priority = logout_protocol_1.LOGOUT_HANDLER_ADAPTER_PRIORITY;
  ***REMOVED***
    LogoutHanlderAdapter_1 = LogoutHanlderAdapter;
    LogoutHanlderAdapter.prototype.handle = function () {
        return __awaiter(this, void 0, void 0, function () {
        ...
        ***REMOVED***
    ***REMOVED***
    LogoutHanlderAdapter.prototype.canHandle = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        ***REMOVED***
    ***REMOVED***
    var LogoutHanlderAdapter_1;
    __decorate([
        core_1.Autowired(logout_protocol_1.LogoutHandler),
        __metadata("design:type", Array)
    ], LogoutHanlderAdapter.prototype, "logoutHandlers", void 0);
    __decorate([
    ...
    ], LogoutHanlderAdapter.prototype, "logoutSuccessHandlerProvider", void 0);
    __decorate([
        core_1.Value('malagu.security.logoutUrl'),
        __metadata("design:type", String)
    ], LogoutHanlderAdapter.prototype, "logoutUrl", void 0);
    __decorate([
        core_1.Value('malagu.security.logoutMethod'),
        __metadata("design:type", String)
    ], LogoutHanlderAdapter.prototype, "logoutMethod", void 0);
    __decorate([
        core_1.Autowired(node_1.RequestMatcher),
        __metadata("design:type", Object)
    ], LogoutHanlderAdapter.prototype, "requestMatcher", void 0);
    LogoutHanlderAdapter = LogoutHanlderAdapter_1 = __decorate([
        core_1.Component([LogoutHanlderAdapter_1, node_1.HandlerAdapter])
    ], LogoutHanlderAdapter);
    return LogoutHanlderAdapter;
***REMOVED***());
exports.LogoutHanlderAdapter = LogoutHanlderAdapter;
...
var SecurityContextLogoutHandler = /** @class */ (function () {
  ...
  ***REMOVED***
    SecurityContextLogoutHandler_1 = SecurityContextLogoutHandler;
    SecurityContextLogoutHandler.prototype.logout = function () {
        ...
        ***REMOVED***
    ***REMOVED***
    var SecurityContextLogoutHandler_1;
    SecurityContextLogoutHandler = SecurityContextLogoutHandler_1 = __decorate([
        core_1.Component([SecurityContextLogoutHandler_1, logout_protocol_1.LogoutHandler])
...
exports.LOGOUT_HANDLER_ADAPTER_PRIORITY = 500;
...
var SimpleUrlLogoutSuccessHandler = /** @class */ (function () {
  ...
  ***REMOVED***
    ...
    SimpleUrlLogoutSuccessHandler.prototype.onLogoutSuccess = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (node_1.Context.getRequest().headers[node_2.X_REQUESTED_WITH] !== node_1.XML_HTTP_REQUEST) {
...
***REMOVED***(http_error_1.HttpError));
  ...
  ***REMOVED***
    HandlerExecutionChainImpl.prototype.execute = function (middlewares) {
        ...
        return middleware(context_1.Context.getCurrent(), {
            handle: function (c, next) { return _this.handlerMapping.handle(); ***REMOVED***,
            priority: 0
        ***REMOVED***
    ***REMOVED***
    __decorate([
...
/***/ "./node_modules/malagu-winston/lib/node/index.js":
/*!*******************************************************!*\
  !*** ./node_modules/malagu-winston/lib/node/index.js ***!
  \*******************************************************/
/*! no static exports found */
...
***REMOVED***
Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***
__export(__webpack_require__(/*! ./logger */ "./node_modules/malagu-winston/lib/node/logger/index.js"));


/***/ ***REMOVED***),

/***/ "./node_modules/malagu-winston/lib/node/logger/index.js":
/*!**************************************************************!*\
  !*** ./node_modules/malagu-winston/lib/node/logger/index.js ***!
  \**************************************************************/
/*! no static exports found */
...
***REMOVED***
Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***
__export(__webpack_require__(/*! ./winston-logger */ "./node_modules/malagu-winston/lib/node/logger/winston-logger.js"));
__export(__webpack_require__(/*! ./winston-logger-protocol */ "./node_modules/malagu-winston/lib/node/logger/winston-logger-protocol.js"));


/***/ ***REMOVED***),

/***/ "./node_modules/malagu-winston/lib/node/logger/winston-logger-protocol.js":
/*!********************************************************************************!*\
  !*** ./node_modules/malagu-winston/lib/node/logger/winston-logger-protocol.js ***!
  \********************************************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***
exports.WinstonConfig = Symbol('WinstonConfig');


/***/ ***REMOVED***),

/***/ "./node_modules/malagu-winston/lib/node/logger/winston-logger.js":
/*!***********************************************************************!*\
  !*** ./node_modules/malagu-winston/lib/node/logger/winston-logger.js ***!
  \***********************************************************************/
/*! no static exports found */
...
var winston_logger_protocol_1 = __webpack_require__(/*! ./winston-logger-protocol */ "./node_modules/malagu-winston/lib/node/logger/winston-logger-protocol.js");
var WinstonLogger = /** @class */ (function () {
    function WinstonLogger(config, winstonConfig1) {
        this.config = config;
        this.winstonConfig1 = winstonConfig1;
        var winstonConfig = this.config.winstonConfig;
        this.logger = winston_1.createLogger(__assign(__assign({ transports: [new winston_1.transports.Console()] ***REMOVED***, winstonConfig), winstonConfig1));
  ***REMOVED***
    WinstonLogger.prototype.addTransports = function (transport) {
        var _this = this;
        if (Array.isArray(transport)) {
            transport.map(function (item) { return _this.logger.add(item); ***REMOVED***
        ***REMOVED***
      ***REMOVED***
        this.logger.add(transport);
    ***REMOVED***
    WinstonLogger.prototype.removeTransports = function (transport) {
        var _this = this;
        if (Array.isArray(transport)) {
            transport.map(function (item) { return _this.logger.remove(item); ***REMOVED***
        ***REMOVED***
      ***REMOVED***
        this.logger.remove(transport);
    ***REMOVED***
    WinstonLogger.prototype.getRawLogger = function () {
        return this.logger;
    ***REMOVED***
    WinstonLogger.prototype.getMessagePrefix = function () {
        var hostname = os.hostname();
        var pid = process.pid;
        if (node_1.Context.getCurrent()) {
            var traceId = node_1.Context.getTraceId();
            var path = node_1.Context.getRequest().path;
            var method = node_1.Context.getRequest().method;
            return method.toLocaleUpperCase() + " " + path + " ( " + pid + " on " + hostname + ")" + (traceId ? " with " + traceId : '');
        ***REMOVED***
      ***REMOVED***
        return "(" + pid + " on " + hostname + ")";
    ***REMOVED***
    WinstonLogger.prototype.error = function (message, prefix) {
        if (prefix === void 0) { prefix = this.getMessagePrefix(); ***REMOVED***
        this.logger.error(prefix + " " + message);
    ***REMOVED***
    WinstonLogger.prototype.warn = function (message, prefix) {
        if (prefix === void 0) { prefix = this.getMessagePrefix(); ***REMOVED***
        this.logger.warn(prefix + " " + message);
    ***REMOVED***
    WinstonLogger.prototype.info = function (message, prefix) {
        if (prefix === void 0) { prefix = this.getMessagePrefix(); ***REMOVED***
        this.logger.info(prefix + " " + message);
    ***REMOVED***
    WinstonLogger.prototype.debug = function (message, prefix) {
        if (prefix === void 0) { prefix = this.getMessagePrefix(); ***REMOVED***
        this.logger.debug(prefix + " " + message);
    ***REMOVED***
    WinstonLogger.prototype.verbose = function (message, prefix) {
        if (prefix === void 0) { prefix = this.getMessagePrefix(); ***REMOVED***
        this.logger.verbose(prefix + " " + message);
    ***REMOVED***
    WinstonLogger = __decorate([
        core_1.Component({ id: core_1.Logger, rebind: true ***REMOVED***),
        __param(0, core_1.Value(core_1.LOGGER_CONFIG)),
        __param(1, core_1.Autowired(winston_logger_protocol_1.WinstonConfig)),
...
/***/ "./node_modules/malagu-winston/lib/node/module.js":
/*!********************************************************!*\
  !*** ./node_modules/malagu-winston/lib/node/module.js ***!
  \********************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
__webpack_require__(/*! . */ "./node_modules/malagu-winston/lib/node/index.js");
exports.default = core_1.autoBind();
...
var AuthenticationProviderImpl = /** @class */ (function () {
    function AuthenticationProviderImpl() {
        this.priority = node_1.DEFAULT_AUTHENTICATION_PROVIDER_PRIORITY;
  ***REMOVED***
    AuthenticationProviderImpl.prototype.authenticate = function () {
  ...
  ***REMOVED***
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blogService.fetchArticleList(1, limit, {
                                pv: 'DESC'
                          ***REMOVED***)];
                    case 1:
                        result = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.blogService.fetchArticleList(currentPage, 20, undefined, condition)];
                    case 1:
                        result = _a.sent();
                        result.list = result.list.map(function (item) { return pick(item, ['title', 'slug', 'archiveTime', 'digest', 'illustration', 'author', 'tags', 'category', 'articleStatus']); ***REMOVED***
                        return [2 /*return*/, Promise.resolve(result)];
              ***REMOVED***
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
    BlogServerImpl.prototype.fetchArticleDetail = function (slug, shouldBeUpdateStats) {
        if (shouldBeUpdateStats === void 0) { shouldBeUpdateStats = false; ***REMOVED***
        return __awaiter(this, void 0, Promise, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blogService.fetchArticleDetail(slug, shouldBeUpdateStats)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Promise.resolve(result)];
              ***REMOVED***
        ...
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        list = result.map(function (item) { return pick(item, ['title', 'slug']); ***REMOVED***
    ...
    ***REMOVED***
    BlogServerImpl.prototype.fetchWebsiteChangeLog = function () {
        ...
        ***REMOVED***
    ***REMOVED***
    BlogServerImpl.prototype.fetchWebsiteStatistics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.websiteService.fetchWebsiteStatistics()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Promise.resolve(result)];
              ***REMOVED***
    ...
    ***REMOVED***
    BlogServerImpl.prototype.fetchHottestArticleLast7Days = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.blogService.fetchHottestArticleRecently()];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, Promise.resolve(result)];
              ***REMOVED***
    ...
    ***REMOVED***
    ...
    __decorate([
        core_1.Autowired(core_1.Logger),
        __metadata("design:type", typeof (_d = typeof malagu_winston_1.WinstonLogger !== "undefined" && malagu_winston_1.WinstonLogger) === "function" ? _d : Object)
    ], BlogServerImpl.prototype, "logger", void 0);
...
var node_3 = __webpack_require__(/*! @malagu/security/lib/node */ "./node_modules/@malagu/security/lib/node/index.js");
// 以下api都是需要身份校验
var BlogAdminController = /** @class */ (function () {
    function BlogAdminController() {
  ***REMOVED***
    // 新建博客
    BlogAdminController.prototype.createBlog = function (article) {
        return __awaiter(this, void 0, void 0, function () {
            var userInfo, username, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userInfo = node_3.SecurityContext.getAuthentication().principal;
    ...
    ***REMOVED***
    // 更新博客内容
    BlogAdminController.prototype.updateBlog = function (article) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ***REMOVED***
    ...
    __decorate([
        ...
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_b = typeof blog_protocol_1.DouMiBlog !== "undefined" && blog_protocol_1.DouMiBlog.ArticleDetail) === "function" ? _b : Object]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        ...
        __param(0, node_1.Body()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_c = typeof blog_protocol_1.DouMiBlog !== "undefined" && blog_protocol_1.DouMiBlog.ArticleDetail) === "function" ? _c : Object]),
        __metadata("design:returntype", Promise)
...
***REMOVED***
Object.defineProperty(exports, "__esModule", { value: true ***REMOVED***
__export(__webpack_require__(/*! ./logger.config */ "./src/node/configs/logger.config.ts"));


/***/ ***REMOVED***),

/***/ "./src/node/configs/logger.config.ts":
/*!*******************************************!*\
  !*** ./src/node/configs/logger.config.ts ***!
  \*******************************************/
/*! no static exports found */
...
var malagu_winston_1 = __webpack_require__(/*! malagu-winston */ "./node_modules/malagu-winston/lib/node/index.js");
var winston_1 = __webpack_require__(/*! winston */ "winston");
var DailyRotateFile = __webpack_require__(/*! winston-daily-rotate-file */ "winston-daily-rotate-file");
var WinstonConfigImpl = /** @class */ (function () {
    function WinstonConfigImpl(config, mode) {
        this.config = config;
        this.mode = mode;
        var dailyRotateConfig = this.config.dailyRotateConfig;
        this.transports = [
            new DailyRotateFile(__assign(__assign({***REMOVED***, dailyRotateConfig), { format: winston_1.format.combine(winston_1.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss,SSS' ***REMOVED***), winston_1.format.simple(), winston_1.format.printf(function (msg) {
                    return msg.timestamp + " - " + msg.level + ": " + msg.message;
              ***REMOVED***)) ***REMOVED***)),
        ];
        if (this.mode.includes('local')) {
            this.transports.push(new winston_1.transports.Console({
                format: winston_1.format.combine(winston_1.format.colorize(), winston_1.format.timestamp({ format: 'YYYY-MM-DD HH:mm:ss,SSS' ***REMOVED***), winston_1.format.simple(), winston_1.format.printf(function (msg) {
                    return msg.timestamp + " - " + msg.level + ": " + msg.message;
              ***REMOVED***)),
          ***REMOVED***));
      ***REMOVED***
        ;
  ***REMOVED***
    WinstonConfigImpl = __decorate([
        core_1.Component(malagu_winston_1.WinstonConfig),
        __param(0, core_1.Value(core_1.LOGGER_CONFIG)),
        __param(1, core_1.Value('mode')),
        __metadata("design:paramtypes", [Object, String])
    ], WinstonConfigImpl);
    return WinstonConfigImpl;
***REMOVED***());
exports.WinstonConfigImpl = WinstonConfigImpl;
...
var Website = /** @class */ (function () {
  ...
  ***REMOVED***
    ...
    __decorate([
        typeorm_1.Column('bigint'),
        __metadata("design:type", Number)
    ], Website.prototype, "yesterdayPv", void 0);
    __decorate([
        typeorm_1.Column('bigint'),
        __metadata("design:type", Number)
    ], Website.prototype, "yesterdayUv", void 0);
    __decorate([
        typeorm_1.Column('bigint'),
        __metadata("design:type", Number)
...
__webpack_require__(/*! ./configs */ "./src/node/configs/index.ts");
...
var entities = __importStar(__webpack_require__(/*! ./entity */ "./src/node/entity/index.ts"));
var core_1 = __webpack_require__(/*! @malagu/core */ "./node_modules/@malagu/core/lib/common/index.js");
...
var BlogService = /** @class */ (function () {
  ...
  ***REMOVED***
    BlogService.prototype.fetchArticleList = function (currentPage, pageSize, order, condition) {
        ...
        if (pageSize === void 0) { pageSize = 20; ***REMOVED***
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var repo, baseQuery, whereQuery, list, count, orderField_1, orderDef_1, queryBuilder, finalQuery;
            var _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                    ...
                    case 5:
                        if (condition.articleStatus) {
                            whereQuery = {
                                where: __assign(__assign({***REMOVED***, whereQuery.where), { articleStatus: condition.articleStatus ***REMOVED***)
                            ***REMOVED***
                      ***REMOVED***
                        _d.label = 6;
                    case 6:
                        finalQuery = __assign(__assign({***REMOVED***, baseQuery), whereQuery);
                        this.logger.info("search blog list with query condition: " + JSON.stringify(finalQuery));
                        if (!!((_a = condition) === null || _a === void 0 ? void 0 : _a.queryTag)) return [3 /*break*/, 8];
                        return [4 /*yield*/, repo.findAndCount(finalQuery)];
                    case 7:
                        _c = __read.apply(void 0, [_d.sent(), 2]), list = _c[0], count = _c[1];
                        _d.label = 8;
                    case 8: return [2 /*return*/, { list: list.map(function (item) { return (__assign(__assign({***REMOVED***, item), { tags: item.tags.map(function (it) { return it.name; ***REMOVED***), category: item.category.name, archiveTime: item.fullArchiveTime, author: item.author.username ***REMOVED***)); ***REMOVED***), pageCount: Math.ceil(count / pageSize), currentPage: currentPage ***REMOVED***];
              ***REMOVED***
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [2 /*return*/, __assign(__assign({***REMOVED***, result), { tags: result.tags.map(function (it) { return it.name; ***REMOVED***), category: result.category.name, catId: result.category.id, archiveTime: result.fullArchiveTime, author: result.author.username ***REMOVED***)];
              ***REMOVED***
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***
    BlogService.prototype.updateArticleStatictics = function (slug) {
        return __awaiter(this, void 0, void 0, function () {
            var reqIp, now, readerRepo, hasTodayItems, beyond7Days, results, reader, newReader;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                      ...
                      ***REMOVED***
                        ...
                        return [4 /*yield*/, readerRepo.find({ date: now ***REMOVED***)];
                    case 1:
                        hasTodayItems = _a.sent();
                        if (!!hasTodayItems.length) return [3 /*break*/, 4];
                        beyond7Days = new Date().getTime() - 7 * 24 * 3600 * 1000;
                        return [4 /*yield*/, readerRepo.find({ date: awesome_js_1.AwesomeHelp.convertDate(new Date(beyond7Days), 'YYYY-MM-DD') ***REMOVED***)];
                    case 2:
                        results = _a.sent();
                        if (!results.length) return [3 /*break*/, 4];
                        return [4 /*yield*/, readerRepo.delete(results.map(function (it) { return it.id; ***REMOVED***))];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4: return [4 /*yield*/, readerRepo.findOne({
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, result.map(function (item) { return ({
                                ...
                                name: '',
                                articlesCount: item.articles.length
                            ***REMOVED*** ***REMOVED***).sort(function (a, b) { return new Date(b.archiveTime).getTime() - new Date(a.archiveTime).getTime(); ***REMOVED***)];
              ***REMOVED***
            ***REMOVED***
        ***REMOVED***
    ***REMOVED***
    ...
    ***REMOVED***
     ...
     * 查询最近最热门的文章，最多可查7天
    */
    BlogService.prototype.fetchHottestArticleRecently = function () {
        return __awaiter(this, void 0, void 0, function () {
            var readerRepo, reader, result, sortResult, articleRepo, articles, finalRes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        readerRepo = node_2.OrmContext.getRepository(reader_1.Reader);
                        return [4 /*yield*/, readerRepo.find()];
                    case 1:
                        reader = _a.sent();
                        result = [];
                        reader.forEach(function (item) {
                            var index = result.findIndex(function (it) { return it.slug === item.articleSlug; ***REMOVED***
                            if (index !== -1) {
                          ...
                          ***REMOVED***
                        ***REMOVED***
                        sortResult = result.sort(function (a, b) { return b.count - a.count; ***REMOVED***).slice(0, 9);
                        articleRepo = node_2.OrmContext.getRepository(article_1.Article);
                        return [4 /*yield*/, Promise.all(sortResult.map(function (it) { return articleRepo.findOne({ slug: it.slug ***REMOVED*** ***REMOVED***))];
                    case 2:
                        articles = _a.sent();
                        finalRes = sortResult.map(function (item, idx) { return (__assign(__assign({***REMOVED***, item), { name: articles[idx].title ***REMOVED***)); ***REMOVED***
    ...
    ***REMOVED***
    ...
    __decorate([
        core_1.Autowired(core_1.Logger),
        __metadata("design:type", typeof (_b = typeof malagu_winston_1.WinstonLogger !== "undefined" && malagu_winston_1.WinstonLogger) === "function" ? _b : Object)
    ], BlogService.prototype, "logger", void 0);
    __decorate([
        node_2.Transactional(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Object, typeof (_c = typeof blog_protocol_1.DouMiBlog !== "undefined" && blog_protocol_1.DouMiBlog.QueryCondition) === "function" ? _c : Object]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        node_2.Transactional(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [typeof (_d = typeof blog_protocol_1.DouMiBlog !== "undefined" && blog_protocol_1.DouMiBlog.ArticleDetail) === "function" ? _d : Object, String, Object]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", Promise)
    ], BlogService.prototype, "fetchHottestArticleRecently", null);
...
var WebsiteService = /** @class */ (function () {
  ...
  ***REMOVED***
    WebsiteService.prototype.updateWebsiteStatistics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var reqIp, now, repo, website, yesterday, yesResult, newData, beyond7Days, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (node_1.Context.getRequest().headers['x-real-ip']) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, repo.findOne({ date: awesome_js_1.AwesomeHelp.convertDate(new Date(yesterday), 'YYYY-MM-DD') ***REMOVED***)];
                    case 3:
                        yesResult = _a.sent();
                        ...
                        repo.save(newData);
                        beyond7Days = new Date().getTime() - 7 * 24 * 3600 * 1000;
                        return [4 /*yield*/, repo.findOne({ date: awesome_js_1.AwesomeHelp.convertDate(new Date(beyond7Days), 'YYYY-MM-DD') ***REMOVED***)];
                    case 4:
                        result = _a.sent();
                        if (result) {
    ...
    ***REMOVED***
    WebsiteService.prototype.websiteChangeLog = function () {
        ...
        ***REMOVED***
    ***REMOVED***
    WebsiteService.prototype.fetchWebsiteStatistics = function () {
        return __awaiter(this, void 0, void 0, function () {
            var repo, results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, results.map(function (item) {
                                var partial = pick(item, ['todayPv', 'todayUv', 'totalPv', 'date']);
                                var pvGrowthRate = +((((item.totalPv - item.yesterdayPv) / item.yesterdayPv) * 100).toFixed(2));
                                var uvGrowthRate = +((((item.totalUv - item.yesterdayUv) / item.yesterdayUv) * 100).toFixed(2));
                                return __assign(__assign({***REMOVED***, partial), { todayPv: +partial.todayPv, todayUv: +partial.todayUv, totalPv: +partial.totalPv, // 这里强转有精度丢失的风险，考虑到目前还不会达到那么大的数目
                                    pvGrowthRate: pvGrowthRate,
                                    uvGrowthRate: uvGrowthRate ***REMOVED***
                          ***REMOVED***)];
              ***REMOVED***
            ***REMOVED***
        ***REMOVED***
    ...
    ***REMOVED***
    ...
    __decorate([
        core_1.Autowired(core_1.Logger),
        __metadata("design:type", typeof (_a = typeof malagu_winston_1.WinstonLogger !== "undefined" && malagu_winston_1.WinstonLogger) === "function" ? _a : Object)
    ], WebsiteService.prototype, "logger", void 0);
    __decorate([
        node_2.Transactional(),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
