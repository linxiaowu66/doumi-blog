  ...
  ***REMOVED***
  ...
  return (
    <Card className={classes.card***REMOVED***>
      ...
      <CardActions className={classes.listAction***REMOVED***>
        <div>
          <Button size="small" color="primary" style={{ lineHeight: 1***REMOVED******REMOVED***>
            <a href={sinaLink***REMOVED*** target="__blank">
          ...
          <Button size="small" color="primary" style={{ lineHeight: 1***REMOVED******REMOVED*** className={classes.weixinShare***REMOVED*** onClick={handleToggleWeixin***REMOVED***>
            ...
            <div className={classes.qrCode***REMOVED*** style={isShowWeixinQrCode ? { display: 'block'***REMOVED*** : { display: 'none'***REMOVED******REMOVED***>
              <span style={{ color: 'rgba(0, 0, 0, 0.54)'***REMOVED******REMOVED***>微信扫一扫</span>
              <QRCode value={weixinLink***REMOVED*** size={94***REMOVED*** includeMargin />
            </div>
          </Button>
        </div>
