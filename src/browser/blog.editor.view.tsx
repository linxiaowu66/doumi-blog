  ...
  handleSubmit = async(actionType: string) => {
    ...
    ***REMOVED***
    ...
    const result = editMode ?
      await axios.put(`${this.endpoint ? this.endpoint : ''***REMOVED***/api/blog`, { ...postBody, slug: this.state.slug ***REMOVED***, {withCredentials: true***REMOVED***) :
      await axios.post(`${this.endpoint ? this.endpoint : ''***REMOVED***/api/blog`, postBody, {withCredentials: true***REMOVED***
