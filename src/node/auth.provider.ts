...
import { AuthenticationProvider, Authentication, DEFAULT_AUTHENTICATION_PROVIDER__PRIORITY, PasswordEncoder, UserStore, UserChecker, BadCredentialsError ***REMOVED*** from '@malagu/security/lib/node';
